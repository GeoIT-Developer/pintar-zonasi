        ...
        <>
            ...
            <Sidebar visible={layoutState.configSidebarVisible} onHide={onConfigSidebarHide} position="right" className="layout-config-sidebar w-20rem">
                ...
                <div className="grid">
                    ...
                    <div className="col-3">
                        <button className="p-link w-2rem h-2rem" onClick={() => _changeTheme('lara-light-amber', 'light')}>
                            <img src="/layout/images/themes/lara-light-amber.png" className="w-2rem h-2rem" alt="Lara Light Amber" />
                        </button>
                    </div>
                    <div className="col-3">
                        <button className="p-link w-2rem h-2rem" onClick={() => _changeTheme('lara-light-pink', 'light')}>
                            <img src="/layout/images/themes/lara-light-pink.png" className="w-2rem h-2rem" alt="Lara Light Pink" />
                        </button>
                    </div>
                    <div className="col-3">
