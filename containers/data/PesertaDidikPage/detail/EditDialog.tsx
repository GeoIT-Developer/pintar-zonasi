...
export default function EditDialog({ onCancel, show, name, row, onRefresh, metadata_id }: Props) {
    ...
    const apiEditPesertaDidik = useAPI<ObjectLiteral, PesertaDidikType & { metadata_id: string }>(
        API.putEditPesertaDidikDatum,
        {
            onSuccess: () => {
                onRefresh();
                toast.current?.show({
                ...
                footer={
                    <>
                        ...
                        <Button
                            ...
                            onClick={onClickSave}
                            text
                            loading={apiEditPesertaDidik.loading}
                        />
                    </>
                }
            >
