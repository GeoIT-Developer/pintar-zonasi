...
export default function TambahDialog({ onCancel, show, onRefresh, metadata_id }: Props) {
    ...
    const apiTambahSekolah = useAPI<ObjectLiteral, Omit<SekolahType, 'id'> & { metadata_id: string }>(
        API.postTambahSekolahDatum,
        {
            onSuccess: () => {
                onRefresh();
                toast.current?.show({
                ...
                footer={
                    <>
                        ...
                        <Button
                            ...
                            onClick={onClickSave}
                            text
                            loading={apiTambahSekolah.loading}
                        />
                    </>
                }
            >
