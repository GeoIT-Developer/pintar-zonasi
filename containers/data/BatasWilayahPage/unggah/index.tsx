...
export default function UnggahBatasWilayahPage() {
    ...
    return (
        <div className="grid">
            <div className="col-12">
                <div className="card">
                    <h5 className="mb-0">Unggah Data Batas Wilayah</h5>
                </div>
            </div>
            <div className="col-12">
            ...
            <Dialog
                header="Unggah Data Batas Wilayah"
                ...
                footer={
                    <>
                        ...
                        <Button
                            ...
                            text
                            loading={apiUnggahBatasWilayah.loading}
                        />
                    </>
                }
            >
                <div className="flex align-items-center justify-content-center">
                    ...
                    <span>
                        Anda yakin ingin mengunggah data batas wilayah <b>{inputData.nama}</b>?
                    </span>
                </div>
            </Dialog>
