...
function BatasWilayahLayer({
    detailData,
    beforeUid,
    layer,
}: {
    detailData: BatasWilayahMetadataType;
    beforeUid?: string;
    ...
    useWMSLayer({
        ...
        styles: GEOSERVER_SETTING.STYLES.ORANGE_LINE_STRIP,
...
function SekolahLayer({
    ...
    usePointLayer({
        ...
        label: layer.showLabel ? 'nama' : undefined,
        fitbounds: false,
        beforeLayer: beforeUid,
        uid: detailData.id,
    ...
    return (
        <>
            {layer.type === DataType.BATAS_WILAYAH && apiBatasWilayahDetail.data && (
                <BatasWilayahLayer
                    detailData={apiBatasWilayahDetail.data}
                    key={layer.id}
                    beforeUid={beforeUid}
                    layer={layer}
                />
            ...
            {layer.type === DataType.JALAN && apiJalanDetail.data && (
                <JalanLayer detailData={apiJalanDetail.data} key={layer.id} beforeUid={beforeUid} layer={layer} />
            )}
